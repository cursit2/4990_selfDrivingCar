...
public class Node
{
    ...
    public bool bIsRoad;//Tells the program if this node is being obstructed.
    ...
    public Node(bool a_bIsRoad, Vector3 a_vPos, int a_igridX, int a_igridY)//Constructor
    {
        bIsRoad = a_bIsRoad;//Tells the program if this node is on a road
